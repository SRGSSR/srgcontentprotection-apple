 ...
 */
+ (SRGNetworkRequest *)tokenizeURL:(NSURL *)URL withSession:(NSURLSession *)session completionBlock:(void (^)(NSURL *URL, NSHTTPURLResponse *HTTPResponse))completionBlock;
